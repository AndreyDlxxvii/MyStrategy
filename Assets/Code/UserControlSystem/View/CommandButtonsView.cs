...
using UnityEngine.UI;
    ...
    public class CommandButtonsView : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject _spawnPointButton;
        ...
        private void Start()
        {
            ...
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<IAttack>), _attackButton);
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<IMove>), _moveButton);
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<IPatrol>), _patrolButton);
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<IStop>), _stopButton);
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<IProduceUnitCommand>), _produceUnitButton);
            _buttonsByExecutorType.Add(typeof(ICommandExecutor<ISetRallyPointCommand>), _spawnPointButton);
        }
        ...
        private void setInteractible(bool value)
        {
            ...
            _spawnPointButton.GetComponent<Selectable>().interactable = value;
        }
