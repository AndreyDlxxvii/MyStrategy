...
{
    [Inject] CommandExecutorBase<IMove> _moveCommandExecutor;
    [Inject] CommandExecutorBase<IPatrol> _patrolCommandExecutor;
    [Inject] CommandExecutorBase<IAttack> _attackCommandExecutor;
    ...
    public void Clear()
    {
        ...
        _stopCommandExecutor.ExecuteSpecificCommand(new UnitStop());
    }
}